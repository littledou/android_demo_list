...
/**
 * ByteArrayPool is a source and repository of <code>byte[]</code> objects. Its purpose（目的） is to
 * supply those buffers to consumers who need to use them for a short period（周期） of time and then
